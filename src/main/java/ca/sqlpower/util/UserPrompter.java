...
public interface UserPrompter {
    ...
    public static enum UserPromptResponse {
        ...
        /**
         * Denotes an affirmative response from the user that should
         * create a new instance of what is being prompted on. This
         * is similar to OK except a new object results as well.
         */
        NEW,
    ...
    /**
     * Returns the object the user specified while on this prompt. This may return
     * null in cases where the user canceled or, in some cases, did not ok the prompt.
     */
