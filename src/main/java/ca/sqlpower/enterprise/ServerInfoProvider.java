...
public abstract class ServerInfoProvider {
	...
	public static boolean isServerLicensed(SPServerInfo infos, CookieStore cookieStore) 
	...
	public static String getWatermarkMessage(SPServerInfo infos, CookieStore cookieStore) 
			throws MalformedURLException,IOException 
	{
			...
			CookieStore cookieStore)
	{
		...
		try {
			if (!isServerLicensed(host,port,path,username,password,cookieStore)) {
